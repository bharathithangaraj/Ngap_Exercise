...
public class WordsToNumbers {
	...
	public static void main(String args[]){
		String result = replaceNumbers("forty two");
		System.out.println(result);
	}

	public static String replaceNumbers (String input) {
	    String result = "";
//	    System.out.println(MAGNITUDES[3]);
	    String[] decimal = input.split(MAGNITUDES[3]);
//	    System.out.println(Arrays.asList(decimal));
	    String[] millions = decimal[0].split(MAGNITUDES[2]);
//	    System.out.println(Arrays.asList(millions));
